                ...
                {Array.from({ length: noOfOpenings }).map((_, index) => (
                    <div key={index} className="form-group openings">
                        ...
                        <div className='col'>
                            ...
                            <select className="role" name="role" value={roleType} onChange={(e) => setRoleType(e.target.value)} required>
                        ...
                        <div className='col pr-0 mt-0'>
                            {/* <label htmlFor={`opening-${index + 1}`} className="form-label"> </label>    */}
                            <input type="text" placeholder='No. of position' className="role" id={`opening-${index + 1}`} name={`opening-${index + 1}`} aria-describedby={`opening-${index + 1}-help`} />
                        </div>
                        </div>
                        <div className="input-container form-group row p-2 pb-0 pt-0">
                            <div className='col '>
                            <label htmlFor="modeOfWork" className="form-label"></label>
                            <select className="mof" name="modeOfWork" value={modeOfWork} onChange={(e) => setModeOfWork(e.target.value)} required>
                            ...
                            <input type="text" placeholder='Work Location' className="mof" name="location" value={workLocation} onChange={(e) => setWorkLocation(e.target.value)} required={true} />
                        </div>
                        </div>
                    </div>
                ))}
